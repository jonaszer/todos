...
export default function Navigation() {
  return (
    <aside className="fixed inset-y-0 left-0 w-16 md:w-64 bg-background border-r border-gray-200 dark:border-dark-border-subtle flex flex-col py-4 px-2 md:px-4">
