...
export default async function MarketingLayout({
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="border-b border-gray-200 dark:border-dark-border-subtle bg-background">
      ...
      <footer className="border-t border-gray-200 dark:border-dark-border-subtle bg-background">
